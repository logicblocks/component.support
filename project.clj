(defproject io.logicblocks/component.support "0.1.0-RC1"
  ...
  :codox
  {:namespaces  [#"^component\.support\."]
   :metadata    {:doc/format :markdown}
   :output-path "docs"
   :doc-paths   ["docs"]
   :source-uri  "https://github.com/logicblocks/component.support/blob/{version}/{filepath}#L{line}"}
